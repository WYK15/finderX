...
std::wstring_view trZh(StringId id) {
    ...
    case StringId::PreviewFont: return L"预览字体";
    case StringId::PreviewFontSize: return L"预览字体大小";
    ...
    case StringId::WheelScrollSpeed: return L"滚轮速度";
...
std::wstring_view trEn(StringId id) {
    ...
    case StringId::PreviewFont: return L"Preview font";
    case StringId::PreviewFontSize: return L"Preview font size";
    ...
    case StringId::WheelScrollSpeed: return L"Wheel scroll speed";
